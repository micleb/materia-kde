...
cat <<- EOF
 ...
 ▀▀    ▀▀  ▀▀▀▀▀     ▀▀▀▀▀▀▀▀
  ...
  $gh_desc
  https://github.com/micleb/$gh_repo
...
_download() {
    ...
    wget -O "$temp_file" \
        "https://github.com/micleb/$gh_repo/archive/master.tar.gz"
